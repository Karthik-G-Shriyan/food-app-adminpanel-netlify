...
import { addFood } from '../../service/FoodService.js';
...
const AddFoodPage = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    setLoading(true);
    try {
      await addFood(token, data, image);
      ...
      toast.error('Error while adding the food');
    } finally {
      setLoading(false);
    }
  };
         ...
         <div className="col-12 col-md-10 col-lg-8" style={{ maxWidth: '900px', width: '100%' }}>
          ...
          <div className="d-flex align-items-center mb-4">
            ...
            <div>
              ...
              <p className="text-muted mb-0">Create a new food item for your menu</p>
            </div>
          </div>
